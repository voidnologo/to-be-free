...
/* quote-compilation pages: visually separate each quote */
.prose.quotes>p{position:relative;padding:1.4em 0 0;margin:0;text-align:left;hyphens:none}
.prose.quotes>p+p{border-top:1px solid var(--rule-2)}
.prose.quotes>p:first-child{padding-top:0}
